...
QA root: `H:\NJC 2 (Neoforge 21.1.226)\run-performance-audit`. Results root: sibling `performance-audit-results`. QA uses exact copied mods/config/world, port 25566, `level-name=world-qa`, separate logs, and one timestamped raw directory per run.

...
The local storage volume was reported by Spark as 1.8 TB total and 1.6 TB used (86%); storage media and filesystem remain unverified. Production uses synchronous chunk writes and deflate region compression. Smoothchunk delays saves 300 seconds, caps unloads at 20/tick and disables protochunk saves.

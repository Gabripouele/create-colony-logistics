...
```text
C:\Users\silfe\.gradle\caches\modules-2\files-2.1\maven.modrinth\create\tS7ygzAE\7453cffbd20bdc5acc8ea7afb472bf55538958b\create-tS7ygzAE.jar
```
...
```text
$env:JAVA_HOME='C:\Program Files\Eclipse Adoptium\jdk-21.0.8.9-hotspot'; .\gradlew.bat runServer
```

...
```text
$env:JAVA_HOME='C:\Program Files\Eclipse Adoptium\jdk-21.0.8.9-hotspot'; .\gradlew.bat build
```
...
```text
C:\Users\silfe\OneDrive\Desktop\Modding Minecraft\create-colony-logistics\create-colony-logistics\build\libs\create_colony_logistics-0.3.0-rc.12.jar
```

Backup jar:

```text
C:\Users\silfe\OneDrive\Desktop\Modding Minecraft\Backup\Release\create_colony_logistics-0.3.0-rc.12.jar
```

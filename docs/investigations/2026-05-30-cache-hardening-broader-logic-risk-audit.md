...
- Retried with `JAVA_HOME` set to `C:\Program Files\Eclipse Adoptium\jdk-21.0.8.9-hotspot`; the first retry needed network access to fetch the Gradle wrapper distribution.
